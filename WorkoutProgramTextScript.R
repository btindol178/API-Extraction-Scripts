...
TodaysWorkout7 <- function(x){
 ...
 #ACCOUNT SID
 #ACda9a993e17f8d4450277f2db37037ac5
 #Authentication Token
 #4e7e29395820317ef7e580ff5314cb7e
 # Trial Number
 #+15674323743
 ...
 Sys.setenv(TWILIO_SID = "ACda9a993e17f8d4450277f2db37037ac5")
 Sys.setenv(TWILIO_TOKEN = "4e7e29395820317ef7e580ff5314cb7e")
